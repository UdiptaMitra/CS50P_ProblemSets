...
and prints the result. You're welcome, but not required, to prompt the user explicitly, as by passing a str of your own as an argument
...
text = input("Enter a string with emoticons in it: ")
print("The emoticons replaced with emojis is ", face(text))
