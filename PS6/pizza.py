...
| Special          | $33.50  | $47.95  |
+------------------+---------+---------+
Implement a program that expects exactly one command-line argument, the name (or path) of a CSV file in Pinocchio’s format, and
outputs a table formatted as ASCII art using tabulate, a package on PyPI at pypi.org/project/tabulate. Format the table using the
...
print(tabulate.tabulate(regular, headers="keys", tablefmt="grid"))
