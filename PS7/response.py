r"""When creating a Google Form that prompts users for a short answer (or paragraph), it’s possible to enable response validation
...
Or you could use Google’s built-in support for validating an email address, pmuch like you could use a library in your own code:
